...
import br.com.actaholding.mediaplayer.core.*
import br.com.actaholding.mediaplayer.models.*
...
class MainActivity : AppCompatActivity() {
    ...
    fun openMediaPlayer(){
            ...
            .callbackItemFromContentViewClicked(object : EmpiricusMediaItemClicked {
                override fun itemClicked(actionClick: ActionClick) {
                    ...
                    if (actionClick.viewId == R.id.emp_like) {
                        Handler().postDelayed({
                            empiricusMedia?.updateEvaluation(
                                Evaluation(
                                    "",
                                    "",
                                    "up"
        ...
        Handler().postDelayed({
            ...
            listTest.add(
                PublicationImpl(
                    "id", "slug", "Title here for you",
                    "O text grande parav ver se vai quebrar a linha no layout e nao ficar cagado.",
                    "https://pbs.twimg.com/profile_images/1112802506902568962/1M4O48vX_400x400.png",
                    false,
                    "11/01/2019", Date(122325454),
                    PublicationImpl.ContentImpl(
                        "jskdjs",
                        "Title content",
                        mutableListOf(
                            PublicationImpl.AuthorImpl(
                                "id",
                                "Paulo Linhares",
                                "",
                                "",
                                "",
                                "Desciption for Author"
                            )
                        ),
                        PublicationImpl.ContentValueImpl(
                            ContentValueType.VIDEO,
                            "video"
                        ),
